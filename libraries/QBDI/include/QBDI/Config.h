...
/* #undef QBDI_ARCH_ARM */
/* #undef QBDI_ARCH_AARCH64 */
/* #undef QBDI_ARCH_X86 */
#define QBDI_ARCH_X86_64  1

#define QBDI_PLATFORM_WINDOWS 1
/* #undef QBDI_PLATFORM_LINUX */
/* #undef QBDI_PLATFORM_ANDROID */
